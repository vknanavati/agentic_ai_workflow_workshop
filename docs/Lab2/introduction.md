...
In this workshop, you'll learn common patterns for agents on AWS using open source agent frameworks and managed services. In this Lab you're going to learn how to build Agents with Strands Agents.

Strands Agents is a simple-to-use, code-first framework for building agents. Strands Agents is lightweight and production-ready, supporting many model providers and deployment targets.
